            ...
            <div name="block0" className="ant-col block">
              <Col lg={8} xs={24}>
                ...
                <p>
                  ...
                  For certain common entity types that could be prone to misspellings and name variations—such as persons, organizations, and facilities—we can apply Levenshtein distance to link entities that were mentioned in disparate emails by different people and resolve them to refer to the same parent entity.
                </p>
                <p>
                  The result of this process is what you see in our Entity Explorer: in addition to having the ability to see who is emailing whom and at what approximate volume, we can also see what entities these people are discussing most often.
                </p>
              </Col>
              <Col lg={16} xs={24}>
          ...
          <div className="ant-row block-wrapper">
            <div name="block0" className="ant-col block">
              <Col lg={8} xs={24}>
                <ul>
                  <li>
                    <strong>Importing data:</strong> Email data files are provided by the user that follows the defined schema. A script converts the CSV file into a JSON file.
                    LogStash then imports the JSON file into ElasticSearch.
                  </li>
                  <li>
                    <strong>Performing a search:</strong> The user enters their search term into the web page, and a script formats it into a Query DSL format query.
          ...
          <div className="ant-row block-wrapper">
            <div name="block0" className="ant-col block">
              <Col lg={8} xs={24}>
                <ul>
                  <li>
                    <strong>Creating the topic data:</strong> Topic data is created by first loading the email corpus csv file, taking a sample of emails from this corpus, and preprocessing them to clean them for the algorithm.
                    Models of different topic sizes are then created using the latent Dirichlet allocation (LDA) algorithm using the Gensim library, and the topic distribution and word clouds for the topics are saved to a JSON file.
                  ...
                  <li>
                    <strong>Web service:</strong> The topic modeling web service is implemented using Flask to make the topic modeling data available using REST calls.
