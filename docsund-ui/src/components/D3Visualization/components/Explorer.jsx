...
export default class Explorer extends Component {
  ...
  updateGraphStyle(graphStyleData) {
    const rebasedStyle = deepmerge(this.defaultStyle, graphStyleData.toSheet())
    // this has to be manually called when the style updates since the graphStyle is not a React component
